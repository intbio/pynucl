...
# based on Alexander Rose work 
# http://nglviewer.org/ngl/api/file/src/structure/structure-constants.js.html
...
DefaultResidueRadius = 5.0
 
# http://dx.doi.org/10.1039/b801115j (or 1.6)
CovalentRadii_by_type = {
  'H': 0.31,
  'HE': 0.28,
  'LI': 1.28,
  'BE': 0.96,
...
DefaultResidueHydrophobicity = [ 0.00, 0.00, 0.00 ]
 
 

RnaBases = [ 'A', 'C', 'T', 'G', 'U' ]
 
DnaBases = [ 'DA', 'DC', 'DT', 'DG', 'DU', 'TCY', 'MCY', '5CM' ]
 
PurinBases = [ 'A', 'G', 'DA', 'DG' ]
