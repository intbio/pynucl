...
class a_contacts(struct2cont):
    ...
    def __init__(self,nuclstr_instance,selA,selB=None, **kwargs):
        ...
        super().__init__(nuclstr_instance.u,nucl_sel_expand(selA,nuclstr_instance.nucl_elements),selB=nucl_sel_expand(selB,nuclstr_instance.nucl_elements), time=nuclstr_instance.time, **kwargs)
